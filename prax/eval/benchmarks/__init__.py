...
ADAPTER_NAMES = ("ifeval", "injecagent", "sycophancy", "bfcl", "halueval", "truthfulqa",
                 ...
                 "longcontext", "agentsafety", "locomo", "hotpotqa", "terminal_bench")
...
def get_adapter(name: str, **kwargs) -> BenchmarkAdapter:
    ...
    if key == "terminal_bench":
        from prax.eval.benchmarks.terminal_bench import TerminalBenchAdapter
        return TerminalBenchAdapter(**kwargs)
