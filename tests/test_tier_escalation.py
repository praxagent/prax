...
def _agent(monkeypatch, base_tier="low", ceiling="high"):
    ...
    monkeypatch.setattr(settings_mod.settings, "auto_tier_escalation", True, raising=False)
    monkeypatch.setattr(settings_mod.settings, "auto_tier_escalation_ceiling", ceiling, raising=False)
...
def test_disabled_flag_fails_without_escalating(monkeypatch):
    a = _agent(monkeypatch)
    monkeypatch.setattr(settings_mod.settings, "auto_tier_escalation", False, raising=False)
