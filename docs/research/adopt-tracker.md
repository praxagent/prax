...
| **Sandbox key-in-env exposure** — REMEDIATED | [sandbox-execution-boundary](../security/sandbox-execution-boundary.md) | ✅ | model keys removed from the sandbox image by default (prax-sandbox #4) + coding-session tools gated off (#137); keyless container is the default now |
